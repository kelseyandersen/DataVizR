...
_ggplot2_ to create a map of the USA and then a map of Kansas and highlight Kansas within a larger map of the USA.
...
The naturalearth data have several columns to work with.
...
```{r transform_ks_sf, message=FALSE, include=TRUE, echo=FALSE}
