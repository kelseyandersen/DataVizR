...
```r
install.packages(c("here", "tidyverse", "ggplot2", "ggraph", "igraph", "ggsn", "patchwork", "ggsci", "library", "sf", "ggthemes))
library(tidyverse)
library(ggplot2)
library(ggraph)
library(igraph)
...
## Workshop code and data

\

### Workshop code and data can be downloaded here: 

 * The above file should be downloaded prior to the workshop
 * Once R and rStudio are installed, the R project in this folder should    be opened. All code should be avaiable to workshop participants for     use during the workshop. 
\
\
\
