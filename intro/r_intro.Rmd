...
We can assign values to objects using the assignment operator (AKA "gets arrow:), and use R
...
#### *Packages* are collections of funcitions

-   example of a package and how to install it. 
